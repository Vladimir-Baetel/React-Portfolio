...
const Testimonials = () => {
  return (
    <div className="lg:w-full sm:w-2/3 w-full mx-auto h-full p-8 flex flex-col justify-between gap-8 bg-white/75 dark:bg-black/75 rounded-lg shadow-lg backdrop-blur-sm">
